...
uses
        ...
        ES.BaseControls, ES.Switch, Vcl.StdCtrls, Vcl.ButtonGroup,
        JvComponentBase, JvTrayIcon, Vcl.Menus, Vcl.Buttons,
        JclShell, ShlObj;
...
type
        TfrmMain = class(TForm)
                ...
                procedure JvTrayIconDblClick(Sender: TObject;
        ...
        private
                ...
                NumLock, CapsLock, ScrollLock: Boolean;
        public
                { Public declarations }
                procedure NumLockScreen(var message: TMessage);
                  message WM_NumLockScreen;
                procedure CapsLockScreen(var message: TMessage);
                  message WM_CapsLockScreen;
                procedure ScrollLockScreen(var message: TMessage);
                  message WM_ScrollLockScreen;
                ...
                case code of
                        HC_ACTION:
                                begin
                                        ...
                                        WM_NumLockScreen, Hook.vkCode, 0);
                                        VK_CAPITAL:
                                        PostMessage(frmMain.Handle,
                                        WM_CapsLockScreen, Hook.vkCode, 0);
                                        VK_SCROLL:
                                        PostMessage(frmMain.Handle,
                                        WM_ScrollLockScreen, Hook.vkCode, 0);
                                        end;
                                end;
                end;
        finally
...
procedure HookIt;
begin
        hkHook := SetWindowsHookEx(WH_KEYBOARD_LL, @LowLevelKeyboardProc,
          hInstance, 0);
end;
...
begin
        ...
        begin
                ...
                if IsWindowVisible(frmAbout.Handle) then
                        exit
                else
                        frmAbout.ShowModal;
        end
